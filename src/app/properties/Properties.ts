...
export function mapProperties(raw: DeepReadonly<RawWallpaperProperties>): MappedProperties {
    ...
    setProperty(clockOptions.analog!.ticks!, 'show', raw.clock_analog_ticks_show as WEProperty<'combo'>, _r => parseComboProperty(_r, AnalogClockTickDisplayType));
    ...
    setProperty(clockOptions.analog!.numbers!, 'enabled', raw.clock_analog_numbers as WEProperty<'bool'>, _r => _r.value);
    setProperty(clockOptions.analog!.numbers!, 'show', raw.clock_analog_numbers_show as WEProperty<'combo'>, _r => parseComboProperty(_r, AnalogClockNumberDisplayType));
