...
const FaExclamationTriangle = hoc(faExclamationTriangle);

export { FaSpotify, FaCircleNotch, FaFilter, FaPlug, FaSkull, FaCheckCircle, FaChevronCircleDown, FaExclamationTriangle };
